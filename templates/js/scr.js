...
function afterAddViewed(res){
	showMessage(res);
}
function addViewed(user_id,movie_id){
	$.post("/templates/ajax/ajax.php",{action:"addViewed",user_id:user_id,movie_id:movie_id},afterAddViewed);
}
